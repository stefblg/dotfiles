...
function get_mute {
    ...
    pactl list sinks | grep '^[[:space:]]Mute:' | grep -oE '[^ ]+$'
}
...
function show_volume_notif {
    ...
    dunstify -i audio-volume-muted-blocking -h int:value:$volume -t 2000 -r 2593  -u normal "$volume_icon $volume%"  -h string:hlcolor:$bar_color
}
